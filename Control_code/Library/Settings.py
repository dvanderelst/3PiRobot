...
class ClientConfig:
    ...
    rotation_obtained:          list  = field(default_factory=lambda: [-40.01, -29.91, -18.74, -11.19, -6.69, 0.0, 6.98, 11.19, 20.55, 28.98, 38.74])
    drive_yaw_curl_deg_per_mm:  float = -0.01244
    drive_distance_scale:       float = 0.9807
