...
`added_walls` adds one wall along **y ≈ 0.051·x − 2626, from x ≈ −850 to +1700** (weighted line fit to the changed region, residual rms 35 mm). The five poles are all back at their trained positions, so it is a pure wall addition.
