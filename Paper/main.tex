...
Unless stated otherwise, the figures below are out-of-fold: each of the $2775$ echoes was scored once, by the model of the four spatial folds that had not seen it. Overall, the class of the nearest reflector was recovered on $79.4\%$ of echoes. That single number, though, averages over a strong dependence on range, and the dependence is the result (Fig.~\ref{fig:inverse-results}).
