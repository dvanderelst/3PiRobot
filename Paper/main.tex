...
\subsubsection{First arena}

The first arena held five rectangular blocks and a single pole, and the path was a closed loop of $8.8$\,m drawn between them. Each run of $500$ steps therefore covered about eight and a half laps.
